# 📺 Ciasom
지정된 사용자 외 실시간 모자이크 라이브 스트리밍 플랫폼

## 🏷 개요
개인 방송인이 야외에서 방송을 찍다보면 의도치 않게 다른 사람의 초상권을 침해할 수 있다.

## 🖥️ 프로젝트 소개
스트리머의 사진을 모델학습하여 실시간 스트리밍 시 학습된 모델 이외의 사람들은 모자이크 처리를 하는 라이브 스트리밍 플랫폼
<br>

##  👨‍👨‍👧‍👧 팀 소개
지준오(FE,BE), 전찬수(AI), 최호성, 백지원(FE)
<br>
